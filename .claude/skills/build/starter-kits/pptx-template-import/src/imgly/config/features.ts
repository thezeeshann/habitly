/**
 * Feature Configuration - Enable/Disable PPTX Template Import Capabilities
 *
 * This file configures which features are available in the editor.
...
/**
 * Configure which features are enabled in the editor.
 *
