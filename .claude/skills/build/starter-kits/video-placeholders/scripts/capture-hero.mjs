...
async function captureHero() {
  ...
  try {
    ...
    // Output to automated-video-generation since video-placeholders-editor content was merged there
    const assetsDir = join(__dirname, '../../../documentation/src/content/docs/starterkits/automated-video-generation+8om1qg/assets');
    ...
    // Skip dark theme for this starterkit
    console.log('Skipping dark theme capture...');
    await browser.close();
  } finally {
