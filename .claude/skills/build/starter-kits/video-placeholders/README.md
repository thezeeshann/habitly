...
Streamline asset production with video placeholders. Built with [CE.SDK](https://img.ly/creative-sdk) by [IMG.LY](https://img.ly), runs entirely in the browser with no server dependencies.

<p>
  <a href="https://img.ly/docs/cesdk/js/starterkits/automated-video-generation-8om1qg/">Documentation</a>
</p>
