...
# Retrieve the Pexels API key from 1Password
echo "Retrieving Pexels API key from 1Password..."
PEXELS_API_KEY=$(op read "op://moyp6h5pb46a3gas6eatga3lcq/CE.SDK Showcase secrets/NEXT_PUBLIC_CUSTOM_ASSET_LIBRARIES_PEXELS_API_KEY" --account imgly.1password.com)

if [ -z "$PEXELS_API_KEY" ]; then
    echo "Warning: Could not retrieve Pexels API key from 1Password"
    echo "You can get a free API key at https://www.pexels.com/api/"
fi
