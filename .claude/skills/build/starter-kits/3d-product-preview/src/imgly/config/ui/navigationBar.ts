...
export function setupNavigationBar(cesdk: CreativeEditorSDK): void {
  ...
  // #region Mockup Editor Specific
  // Remove document settings from navigation bar since scene inspector
  // is not relevant for mockup editors (3D mockup, product, apparel editors)
