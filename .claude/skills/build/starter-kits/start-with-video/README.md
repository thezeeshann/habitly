...
Initialize the editor with a video matching the page size. Built with [CE.SDK](https://img.ly/creative-sdk) by [IMG.LY](https://img.ly), runs entirely in the browser with no server dependencies.

<p>
  <a href="https://img.ly/docs/cesdk/js/starterkits/start-with-video-swv001/">Documentation</a>
</p>
