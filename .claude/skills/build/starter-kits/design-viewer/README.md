...
Load content into the viewer using one of these methods:
...
│   └── imgly/
│       ├── index.ts          # Viewer initialization
│       └── config/
...
- **Pan & Zoom** – Navigate designs with intuitive controls
- **Page Navigation** – Browse multi-page designs and presentations
- **Zoom Controls** – Zoom in/out with fit-to-screen options
- **Read-Only Mode** – Display content without editing capabilities
- **Approval Workflows** – Review designs without risk of modifications
- **Lightweight Interface** – Minimal UI focused on viewing
...
<p align="center">Built with <a href="https://img.ly/creative-sdk?utm_source=github&utm_medium=project&utm_campaign=starterkit-design-viewer">CE.SDK</a> by <a href="https://img.ly?utm_source=github&utm_medium=project&utm_campaign=starterkit-design-viewer">IMG.LY</a></p>
