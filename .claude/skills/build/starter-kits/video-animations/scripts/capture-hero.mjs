...
async function captureHero() {
  ...
  try {
    ...
    const assetsDir = join(__dirname, '../../../documentation/src/content/docs/starterkits/video-animations+vanim1/assets');
    ...
    console.log('CE.SDK initialized, waiting for scene to load and render...');
    // Give the scene time to load from CDN and render
    ...
    console.log('CE.SDK initialized, waiting for scene to load and render...');
    // Give the scene time to load from CDN and render
    await darkPage.waitForTimeout(15000);
