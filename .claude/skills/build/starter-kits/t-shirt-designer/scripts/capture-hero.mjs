...
async function captureHero() {
  ...
  try {
    ...
    const assetsDir = join(__dirname, '../../../documentation/src/content/docs/starterkits/t-shirt-designer+jwinqr/assets');
    ...
    // Copy light theme to starterkit root
    const starterkitRootHero = join(__dirname, '../hero.webp');
    await copyFile(lightWebpPath, starterkitRootHero);
    console.log('Copied hero.webp to starterkit root');
