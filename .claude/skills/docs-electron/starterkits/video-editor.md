...
Professional video editing for your Electron app—edit clips, add effects, trim
footage, and export to MP4. Runs entirely client-side with no server
dependencies.
...
Integrate the Video Editor into your Electron application using the imperative API.
