...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Translation the Design Editor Internationalization into an existing Electron application. This adds the editor configuration to your current project structure.
