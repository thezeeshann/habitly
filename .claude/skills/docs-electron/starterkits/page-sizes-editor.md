...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Electron application with Page Sizes Editor integration.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Page Sizes Editor into an existing Electron application. This adds the editor configuration to your current project structure.
