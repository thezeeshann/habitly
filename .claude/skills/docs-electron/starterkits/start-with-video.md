...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Start with Video into an existing Electron application. This adds the editor configuration to your current project structure.
    ...
    CreativeEditorSDK.create('#cesdk_container', config)
      .then(async (cesdk) => {
        await initStartWithVideoEditor(cesdk);
      })
      .catch((error) => {
