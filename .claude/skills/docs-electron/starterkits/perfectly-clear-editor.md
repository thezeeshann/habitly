...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Electron application with Perfectly Clear Editor integration.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        ...
        cp -r starterkit-perfectlyclear-editor-ts-web/src/imgly ./src/renderer/imgly
        rm -rf starterkit-perfectlyclear-editor-ts-web
      </TerminalTab>

      <TerminalTab label="degit">
        npx degit imgly/starterkit-perfectlyclear-editor-ts-web/src/imgly ./src/renderer/imgly
      </TerminalTab>
    </TerminalTabs>
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Perfectly Clear Editor into an existing Electron application.
    ...
    <TerminalTabs>
      <TerminalTab label="git">
        git clone https://github.com/imgly/starterkit-perfectlyclear-editor-ts-web.git
        cp -r starterkit-perfectlyclear-editor-ts-web/src/imgly ./src/renderer/imgly rm
        -rf starterkit-perfectlyclear-editor-ts-web
      </TerminalTab>
