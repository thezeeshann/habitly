...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Electron application with Layouts Editor integration.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Layouts Editor into an existing Electron application. This adds the editor configuration to your current project structure.
