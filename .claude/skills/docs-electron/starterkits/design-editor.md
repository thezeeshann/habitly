...
Professional design editing for your Electron app—create graphics, templates,
and multi-page documents. Runs entirely client-side with no server
dependencies.
...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Design Editor into an existing Electron application. This adds the editor configuration to your current project structure.
