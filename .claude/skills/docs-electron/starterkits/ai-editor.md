...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the AI Editor into an existing Electron application. This adds the editor configuration to your current project structure.
      ...
      <TabItem label="Design">
        ...
        CreativeEditorSDK.create('#cesdk_container', config)
          .then(async (cesdk) => {
            ...
            await initAiDesignEditor(cesdk, providers);
          })
          .catch((error) => {
      ...
      <TabItem label="Photo">
        ...
        CreativeEditorSDK.create('#cesdk_container', config)
          .then(async (cesdk) => {
            ...
            await initAiPhotoEditor(cesdk, providers);
          })
          .catch((error) => {
            console.error('Failed to initialize CE.SDK:', error);
          });
      ...
      <TabItem label="Video">
        ...
        CreativeEditorSDK.create('#cesdk_container', config)
          .then(async (cesdk) => {
            ...
            await initAiVideoEditor(cesdk, providers);
          })
          .catch((error) => {
            console.error('Failed to initialize CE.SDK:', error);
          });
