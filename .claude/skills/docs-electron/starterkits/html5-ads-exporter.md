...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Electron application with HTML5 Ads Exporter integration.
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the HTML5 Ads Exporter into an existing Electron application. This adds the editor configuration to your current project structure.
