...
<Tabs syncKey="project-type">
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Content Moderation Editor into an existing Electron application. This adds the editor configuration to your current project structure.
    ...
    CreativeEditorSDK.create('#cesdk_container', config)
      .then(async (cesdk) => {
        await initContentModerationEditor(cesdk);
      })
      .catch((error) => {
