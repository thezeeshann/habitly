...
<Tabs syncKey="project-type">
  <TabItem label="New Project">
    ...
    Create a new Electron application with Pexels Image Editor integration.
    ...
    CreativeEditorSDK.create('#cesdk_container', config)
      .then(async cesdk => {
        await initPexelsImageEditor(cesdk, { pexelsApiKey: PEXELS_API_KEY });
      })
      .catch(error => {
  ...
  <TabItem label="Existing Project">
    ...
    Integrate the Pexels Image Editor into an existing Electron application.
